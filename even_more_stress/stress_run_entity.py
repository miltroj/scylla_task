...
def map_regexp_first_hit_to_numeric(regexp, output, mapping):
...
class CassandraStressRun:
    def __init__(self, thread_id, duration, node_ip):
    ...
    def __repr__(self):
        return f"Run {self.thread_id=} - {self.op_rate=}, {self.latency_mean=}, {self.latency_99th=}, {self.latency_max=}"
